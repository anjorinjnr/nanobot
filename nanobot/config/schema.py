...
class AgentDefaults(Base):
    ...
    disable_memory_writes: bool = False  # When True, suppresses Consolidator/AutoCompact summary writes to memory/history.jsonl and session metadata. Used for guest agents where long-term memory crosses scope/sender boundaries (cross-scope leak risk).
