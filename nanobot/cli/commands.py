...
def serve(
    ...
    agent_loop = AgentLoop(
        ...
        multimodal_model=runtime_config.agents.defaults.multimodal_model,
...
def _run_gateway(
    ...
    *,
    ...
    agent = AgentLoop(
        ...
        multimodal_model=config.agents.defaults.multimodal_model,
    ...
    # Register Dream system job (respects DreamConfig.enabled so Homer can opt out)
